...
st.title(":rainbow[ScheduleAI]")

username = st.sidebar.text_input("Username")
password = st.sidebar.text_input("Password")
st.write("**NOTE: IF 🚨ERROR🚨 OCCURS, PRESS CTRL+R**")
...
try:
    if query:
        ...
        with st.chat_message("assistant"):
            ...
            with httpx.Client(timeout=None) as client:
                with client.stream(
                    ...
                    json={"query": query, "thread_id": username},
                ) as response:
        ...
        toast('Task completed!!!', button={'activationType': 'protocol', 'arguments': 'http://localhost:8501/', 'content': 'Open App'})
